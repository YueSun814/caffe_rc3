...
shared_ptr<Layer<Dtype> > GetPoolingLayer(const LayerParameter& param) {
  ...
  if (engine == PoolingParameter_Engine_CAFFE) {
    ...
    //if (param.pooling_param().pool() == PoolingParameter_PoolMethod_MAX) {//commented by dong
      //  return shared_ptr<Layer<Dtype> >(new PoolingLayer<Dtype>(param));//commented by dong
    //} else {//commented by dong
